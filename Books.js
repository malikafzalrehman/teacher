...
const boardData = {
  'Punjab Board': {
    ...
    'Grade 12': [
      { title: 'TARJUMA TUL QARAN UL MAJEED', icon: 'menu-book', color: '#27ae60',url:"" },
      { title: 'Human Geography', icon: 'calculate', color: '#27ae60',url:"" },
      { title: 'Urdu', icon: 'menu-book', color: '#27ae60',url:"" },
      { title: 'Islamiyat', icon: 'mosque', color: '#16a085',url:""  },
      { title: 'English I (Short stories)', icon: 'translate', color: '#3498db',url:"" },
      { title: 'English III 2020', icon: 'translate', color: '#3498db',url:"" },
      { title: 'Mathematics 2020', icon: 'calculate', color: '#e74c3c',url:""  },
      { title: 'Physics', icon: 'bolt', color: '#f1c40f',url:""  },
      { title: 'Islamiyat Urdu Medium', icon: 'mosque', color: '#16a085',url:""  },
      { title: 'Economics', icon: 'menu-book', color: '#9b59b6',url:"" },
      { title: 'Statistics 2020', icon: 'bolt', color: '#f1c40f',url:""  },
      ...
      { title: 'Civics 2023-24', icon: 'computer', color: '#2c3e50',url:""  },
      { title: 'PANJABI IKHTARI ', icon: 'computer', color: '#2c3e50',url:"" },
      { title: 'Iim ul Taleem', icon: 'mosque', color: '#16a085',url:""  },
      { title: 'Farsi 2020', icon: 'biotech', color: '#2ecc71' ,url:"" },
      { title: 'Mubadiyat falsfa', icon: 'people-outline', color: '##8e44ad',url:"" },
      { title: 'Phychology (Nasfiyat) Urdu Medium', icon: 'people-outline', color: '##8e44ad',url:"" },
      { title: 'Muraqa-e-Adab', icon: 'menu-book', color: '#27ae60',url:"" },
      { title: 'Iim ul Taleem Urdu Medium', icon: 'mosque', color: '#16a085',url:""  },
      { title: 'Akhlaqat 2023-24', icon: 'menu-book', color: '#2c3e50',url:"" },
      { title: 'English II 2025-26', icon: 'translate', color: '#3498db',url:"" },
      { title: 'Physics II 2025-26', icon: 'bolt', color: '#f1c40f',url:""  },
      { title: 'Mathematics II 2025-26', icon: 'calculate', color: '#e74c3c',url:""  },
      { title: 'Biology II 2025-26', icon: 'biotech', color: '#2ecc71',url:""  },,
      { title: 'Computer II 2025-26', icon: 'computer', color: '#2c3e50',url:""  },
      { title: 'Islamiyat', icon: 'mosque', color: '#16a085',url:""  },
      { title: 'Urdu II 2025-26', icon: 'menu-book', color: '#8e44ad',url:"" }
    ]
  },
  'Sindh Board': {
    'Pre-Primary (KG)': [
      ...
      { title: 'Sindhi', icon: 'language', color: '#e67e22' }
    ],
    'Grade 1': [
      { title: 'Urdu', icon: 'menu-book', color: '#27ae60' },
      { title: 'English', icon: 'translate', color: '#3498db' },
    ...
    'Grade 6': [
      ...
      { title: 'Islamiyat', icon: 'mosque', color: '#16a085' },
      { title: 'Pakistan Studies', icon: 'account-balance', color: '#8e44ad' },
      { title: 'Sindhi', icon: 'language', color: '#e67e22' }
    ],
    'Grade 7': [
      { title: 'Urdu', icon: 'menu-book', color: '#27ae60' },
